					 ...
					 if (json != null) {
						try {
						   if (json.getInt("status") == 200) {
							  ...
							  i.putExtra("LaundryOffline", online_offline);

							  i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
...
//                                    imageLoader.DisplayImage(j_obj.getString("BannerURL"), imageView_banner, false);
   ...
   public boolean onOptionsItemSelected(MenuItem item) {
	  ...
	  if (id == android.R.id.home) {
		 ...
		 Intent intent = new Intent(Add_CommentAddress.this, BaseFragmentActivity.class);
