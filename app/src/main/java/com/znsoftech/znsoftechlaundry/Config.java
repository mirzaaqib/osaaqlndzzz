...
public class Config {
   ...
   public static final String apiKey = "AIzaSyCwvpDui9IeSEj7GdgjzLO7Gg32_S-nqQY";
   public static boolean GPS_ENABLED = false;

   public static String website = "http://laundry.znsoftech.com/yii/";

   public static final String SET_COUNTRY = website + "webservice/set/changecountry";
   public final static String urlAdvertisement = website + "webservice/get/advertisement";
   ...
   public static String latest_deal_offers = website + "webservice/get/laundries/tab/latest_offer";
   ...
   public static String Forgot_password_url = website + "webservice/get/forgot";
   ...
   public static String urlEditProfile = website + "webservice/set/edituser";
